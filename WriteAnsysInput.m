...
%WriteAnsysInput_rev2(['material mapped mesh6.txt'],'A',500,[],[],[])
%WriteAnsysInput_rev2(['material mapped mesh6.txt'],'B',500,[],[],[])
%WriteAnsysInput_rev2(['material mapped mesh6.txt'],'C',[],16446,[],[])
%WriteAnsysInput_rev2(['material mapped mesh6.txt'],'D',[],16446,[],[])
%WriteAnsysInput_rev2(['material mapped mesh6.txt'],'E',500,16446,10000,0.4)
%WriteAnsysInput_rev2(['material mapped mesh3.txt'],'A',500,[],[],[])
%WriteAnsysInput_rev2(['material mapped mesh3.txt'],'B',500,[],[],[])
%WriteAnsysInput_rev2(['material mapped mesh3.txt'],'C',[],16446,[],[])
%WriteAnsysInput_rev2(['material mapped mesh3.txt'],'D',[],16446,[],[])
%WriteAnsysInput_rev2(['material mapped mesh3.txt'],'E',500,16446,10000,0.4)
%
function WriteAnsysInput_rev2(GEMfilename,Method,NumOfMats,Ecort,EminShell,ShellTh)
